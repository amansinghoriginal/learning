...
function Show-AccessInstructions($useIngress) {
    ...
    if ($useIngress) {
        ...
        Write-Host "  - Retail Ops:         kubectl port-forward svc/retail-ops 3001:80"
        Write-Host "  - Physical Ops:       kubectl port-forward svc/physical-ops 3002:80"
        Write-Host "  - Delivery Dashboard: kubectl port-forward svc/delivery-dashboard 3003:80"
        Write-Host "  - Delay Dashboard:    kubectl port-forward svc/delay-dashboard 3004:80"
        Write-Host ""
        Write-Host "  Then access at:"
        Write-Host "  - Demo Portal:        http://localhost:3000"
        Write-Host "  - Retail Ops:         http://localhost:3001"
        Write-Host "  - Physical Ops:       http://localhost:3002"
        Write-Host "  - Delivery Dashboard: http://localhost:3003"
        Write-Host "  - Delay Dashboard:    http://localhost:3004"
    }
