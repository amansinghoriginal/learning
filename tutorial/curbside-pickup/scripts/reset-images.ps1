...
param(
    ...
    [ValidateSet("retail-ops", "physical-ops", "delivery-dashboard", "delay-dashboard", "demo", "all")]
    [string]$AppName
)
...
$officialImages = @{
    "retail-ops" = "ghcr.io/drasi-project/learning/curbside-pickup/retail-ops:latest"
    "physical-ops" = "ghcr.io/drasi-project/learning/curbside-pickup/physical-ops:latest"
    "delivery-dashboard" = "ghcr.io/drasi-project/learning/curbside-pickup/delivery-dashboard:latest"
    "delay-dashboard" = "ghcr.io/drasi-project/learning/curbside-pickup/delay-dashboard:latest"
    "demo" = "ghcr.io/drasi-project/learning/curbside-pickup/demo:latest"
}
